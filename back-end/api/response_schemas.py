...
class ConnectDBResponse(BaseResponse):
    ...
    schemas: Optional[List[str]] = Field(
        default=None, description="Available schemas (PostgreSQL)"
    )
    databases: Optional[List[str]] = Field(
        default=None, description="Available databases"
    )
...
class DatabaseStatusResponse(BaseResponse):
    ...
    databases: Optional[List[str]] = Field(
        default=None, description="Available databases for switching"
    )
...
class RunQueryResponse(BaseResponse):
    ...
    affected_rows: Optional[int] = Field(
        default=None, description="For INSERT/UPDATE/DELETE operations"
    )
